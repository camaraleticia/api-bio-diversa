...
try {
    ...
    // Criar e configurar o estimador (rede neural)
    $featuresInfo = $useGrayscale ? "16x16 grayscale — 256 features" : "16x16 RGB — 768 features";
    // Em RGB, o modelo tem 3x mais parâmetros na primeira camada — aumentar Dropout para conter overfitting
    $dropoutRate = $useGrayscale ? 0.2 : 0.4;
    echo "Configurando modelo de rede neural ({$featuresInfo}, dropout={$dropoutRate})...\n";
